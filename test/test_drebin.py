...
class TestDrebin(unittest.TestCase):
    def test_xml_bytecode_parser(self):
        drebin_ana = DrebinAnalyzer("/mnt/9699a7bf-7770-4a52-8da1-494497c49166/git/AI4Code-Framework/data/apk/raw/hello-world.apk", informative=False, dex_only=False)
    ...
    def test_drebin_features(self):
        features = DrebinAnalyzer("/mnt/9699a7bf-7770-4a52-8da1-494497c49166/git/AI4Code-Framework/data/apk/raw/hello-world.apk").features
